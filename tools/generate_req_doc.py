...
def compute_statistics(requirements: list[dict]) -> str:
    ...
    by_verification = Counter(r.get("verificationMethod", "Unspecified") for r in requirements)
...
def render_requirements(
    ...
    for req in reqs:
        ...
        fields += render_field("Verification Method", req.get("verificationMethod"))
        fields += render_field("Verification Criteria", req.get("verificationCriteria"))
